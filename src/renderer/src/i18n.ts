...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "thinking.level.xhigh": "xhigh 高推理档，需当前模型支持",
  "thinking.levelLabel.xhigh": "超高",
  "thinking.level.max": "最高推理档",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "thinking.level.xhigh": "Xhigh reasoning, requires model support",
  "thinking.levelLabel.xhigh": "XHigh",
  "thinking.level.max": "Maximum reasoning, requires model support",
  "thinking.levelLabel.max": "Max",
